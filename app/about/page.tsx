      ...
      <main className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-[#1e1f22] rounded-lg p-8 border border-[#0f1011]">
            <h2 className="text-3xl font-bold mb-4 text-indigo-400">🎅 What is WCordAI?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-[#202225] rounded-lg p-4 border border-[#0f1011]">
                ...
                <p className="text-sm text-gray-400">
                  The boomer admin of WCordAI since 1823. Types in ALL CAPS occasionally. Everything reminds him of "BACK IN MY DAY." Supportive but completely out of touch with modern life.
                </p>
              </div>
